...
| Doc | Read it when |
| --- | --- |
| [adding-a-site.md](adding-a-site.md) | Teaching Emojery to place its picker on a new site — architecture, design invariants, the 11-step checklist |
| [development.md](development.md) | Working with the `pnpm dev` watcher: what to reload after which change, and why the watcher looks stuck |
...
Outside this folder: [CONTRIBUTING.md](../CONTRIBUTING.md) (how to contribute, where a test belongs, pre-PR gates, commit convention), [e2e/README.md](../e2e/README.md) (the e2e suites), [SECURITY.md](../SECURITY.md), and the user-facing docs at [emojery.app](https://emojery.app).
