...
## Notes to reviewer (AMO), 3000 characters max
...
```text
Chrome Web Store  - category: Social & Communication
Microsoft Edge    - category: Social
Firefox (AMO)     - primary: Social & Communication, secondary: Other
```

## Edge search terms (max 7 terms, 30 characters each, 21 words total)
...
## Notes for certification (Edge), 2000 characters max
