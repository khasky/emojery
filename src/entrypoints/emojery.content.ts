...
// is present before the page's own script polls for it. shared/homepage.ts owns the
// host (host_permissions in wxt.config.ts read it from there too); this is NOT a
...
export default defineContentScript({
  ...
  main: () => {
    ...
    } catch {} // if the stamp fails, the page just sees no extension
  },
});
