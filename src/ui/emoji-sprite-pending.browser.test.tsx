...
// emoji-sprite.browser.test.tsx: that one resolves the URL
...
beforeAll(() => {
  ...
  // page-origin blob build. The stubbed fetch serves the real 1x1 PNG for it, so
  // createObjectURL returns a genuine, loadable blob: URL against the page origin.
