...
| `build-context.spec.ts` | The background reading back every file `build-context.json` names, and that index naming a build the build step registered in `.output/build-records/` | No | Manual only |
